  ...
  return (
    <div className="w-full max-w-md mx-auto">
      ...
      <p className="text-[14px] text-[#6B7280] text-center mb-8">
        Sudah punya akun?{' '}
        <a href="/login" className="text-[#10B981] font-medium hover:underline">Masuk</a>
      </p>
  ...
  return (
    <>
      ...
      <div className="relative flex-1 flex items-center justify-center p-6 bg-white">
        <Suspense fallback={<div className="w-full max-w-md mx-auto text-center text-[#9CA3AF] text-sm">Memuat...</div>}>
          <RegisterForm />
        </Suspense>
      </div>
    </>
